...
from app.auth import account_pages
from app.auth import pc_login_api
from app.auth import pages as auth_pages
from app.auth.dependencies import require_mobile_account, require_pc_admin_account
...
app.include_router(account_pages.router, tags=["账号管理"])
app.include_router(
    drawings.router,
    prefix="/api/drawings",
    tags=["图纸识别"],
