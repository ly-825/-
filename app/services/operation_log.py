...
def drawing_snapshot(drawing: ProductDrawing | None) -> dict[str, Any] | None:
    ...
    return {
        ...
        "teeth_count_text": drawing.teeth_count_text,
        "module_text": drawing.module_text,
        "common_normal_length_text": drawing.common_normal_length_text,
...
def inventory_snapshot(item: MaterialInventory | None) -> dict[str, Any] | None:
    ...
    return {
        ...
        "paper_material": item.paper_material,
        "status": item.status,
